    ...
    <body>
        <nav class="navbar navbar-expand-lg navbar-custom">
            ...
            <div class="collapse navbar-collapse" id="navbarsExample09">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="our_story.php" id="dropdown09" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="flag-icon flag-icon-us"> </span> English</a>
                        <div class="dropdown-menu" aria-labelledby="dropdown09">
                            <a class="dropdown-item" href="our_story_TH.php"><span class="flag-icon flag-icon-th"> </span>  Thai</a>
                        </div>
                    </li>
                </ul>
            </div>
        ...
        <div class="row">
            <div class="col-sm-6">
                <h4>About Us</h4>
                <br>
                <h1 style="font-weight: bold">AlzApp's Story</h1>
                <br>
                    <h6 style="line-height: 2;">
                        "The inspiration for AlzApp came from my desire to support my grandmother who has Alzheimer's Desease.
                        Therefore, I designed this website in hopes to assist caretakers in their work with their patients".
                    </h6>
                <br>
                <p style="color: #4B5C7B">Pran Taepaisitphongse </p>
                <p style="color: #4B5C7B">Contact : termt222@gmail.com</p>
                <p style="color: #4B5C7B">Acknowlegement</p>
                <p>The completion of this project could not have been possible without the expertise of these people. I would like to express my sincere gratitude to</p>
                <ol>
                    <li>Sookjaroen Tangwongchai M.D.</li>
                    <li>Wiphada Dendee</li>
                    <li>Fa Taepaisitphongse</li>
                    <li>Jiraporn Taepaisitphongse</li>
                </ol>
            </div>
        <div class="col-sm-6">
